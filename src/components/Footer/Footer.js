            ...
            <div className="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
              ...
              <ul>
                ...
                <li className="mb-3">
                  ...
                  <Link to="/">01123456798</Link>{" "}
                </li>
                <li className="mb-3">
                  <i className="fas fa-phone"></i>
                  <Link to="/">01234567897</Link>{" "}
                </li>
                <li className="mb-3">
                  <i className="fas fa-envelope-open"></i>
                  <Link to="/">saiful.riyaz@gmail.com</Link>
                </li>
                <li>
                  <i className="fas fa-envelope-open"></i>
                  <Link to="/"> sr.islam@gmail.com</Link>
                </li>
              </ul>
            </div>
      ...
      <div className="copy-right py-3">
        <div className="container">
          <p className="text-center ">
            © 2021 <span className="logoName"></span>. All rights
            reserved by
            <span> GadgetSHOP</span>
          </p>
        </div>
      </div>
    </>
